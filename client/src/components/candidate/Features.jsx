      ...
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
          ...
          <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
            ...
            >
              <g fillRule="nonzero">
                <path d="M247.292 94.106C224.124 111.016 190.526 120 1text-gray-300darjk61.608 120c-40.544 0-77.046-14.822-104.673-39.476-2.164-1.936-.235-4.583 2.369-3.082 29.806 17.15 66.66 27.475 104.731 27.475 25.677 0 53.906-5.271 79.884-16.163 3.923-1.646 7.21 2.545 3.373 5.352" />
